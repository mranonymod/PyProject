...
################################################################################
## Form generated from reading UI file 'main_menu2Enfgbf.ui'
##
...
"color:#717072;")
        ...
        self.toggle.setMinimumSize(QSize(50, 0))
...
"background-position:center left;")
        ...
        self.center_side_menu.setStyleSheet(u"background-color: rgb(75, 75, 75);")
        ...
        self.stackedWidget.setGeometry(QRect(-1, -1, 911, 581))
...
"background-color:#fffff2;}")
        ...
        self.tempframe.setGeometry(QRect(-1, -1, 941, 561))
...
"background-color:#fffff2;}")
        ...
        self.tempframe2.setGeometry(QRect(-1, -1, 911, 561))
...
"")
        self.CustID = QLineEdit(self.PasswordBox_3)
        self.CustID.setObjectName(u"CustID")
        self.CustID.setGeometry(QRect(290, 150, 531, 41))
        self.Txnpwd = QLineEdit(self.PasswordBox_3)
        self.Txnpwd.setObjectName(u"Txnpwd")
        self.Txnpwd.setGeometry(QRect(290, 250, 531, 41))
        self.Txnpwd.setEchoMode(QLineEdit.Password)
...
"background-color:#fffff2;}")
        ...
        self.Lgnpwd = QLineEdit(self.PasswordBox_3)
        self.Lgnpwd.setObjectName(u"Lgnpwd")
        self.Lgnpwd.setGeometry(QRect(290, 200, 531, 41))
        self.Lgnpwd.setEchoMode(QLineEdit.Password)
        self.label_11 = QLabel(self.PasswordBox_3)
        self.label_11.setObjectName(u"label_11")
        self.label_11.setGeometry(QRect(120, 110, 141, 31))
        self.label_11.setStyleSheet(u"font-size:20px;")
        self.Service3 = QLineEdit(self.PasswordBox_3)
        self.Service3.setObjectName(u"Service3")
        self.Service3.setGeometry(QRect(290, 100, 531, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toggle.setText("")
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Protekt", None))
        self.Shared.setText(QCoreApplication.translate("MainWindow", u"Shared", None))
        ...
        self.per_password.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Password", None))
        self.Enter.setText(QCoreApplication.translate("MainWindow", u"Enter", None))
        self.checkBox.setText(QCoreApplication.translate("MainWindow", u"I hereby confirm all the details entered are correct.", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"Account Name:", None))
        ...
        self.CustID.setText("")
        self.CustID.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Customer ID/Username", None))
        self.Txnpwd.setText("")
        self.Txnpwd.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Password (If Exists)", None))
        self.Enter_3.setText(QCoreApplication.translate("MainWindow", u"Enter", None))
        self.checkBox_3.setText(QCoreApplication.translate("MainWindow", u"I hereby confirm all the details entered are correct.", None))
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"Customer ID :", None))
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"Login Password :", None))
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"Transaction Password :", None))
        ...
        self.Lgnpwd.setText("")
        self.Lgnpwd.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Password", None))
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"Service Name :", None))
        self.Service3.setText("")
        self.Service3.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Bank Name/App Name", None))
    # retranslateUi
