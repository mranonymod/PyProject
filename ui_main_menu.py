...
"background-color:#fffff2;}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bank_custID.setText(QCoreApplication.translate("MainWindow", u"CustID", None))
        self.bank_custID.setPlaceholderText(QCoreApplication.translate("MainWindow", u"UserName/E-Mail", None))
        self.bank_pwd.setText("")
        self.bank_pwd.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Password", None))
        ...
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"Account No.", None))
